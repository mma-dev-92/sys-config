...
(use-package python-mode
  ...
  :config
  (add-hook 'python-mode-hook #'mma/lsp-set-python-executable)) ;; set Python executable for lsp-pylsp
#+end_src
...
(use-package flycheck
   ...
   (when (bound-and-true-p pyvenv-virtual-env)
     ;; (setq flycheck-python-pylint-executable (concat pyvenv-virtual-env "bin/flake8"))
     (setq flycheck-python-pylint-executable (concat pyvenv-virtual-env "bin/pylint"))
     (setq flycheck-python-mypy-executable (concat pyvenv-virtual-env "bin/mypy"))))
